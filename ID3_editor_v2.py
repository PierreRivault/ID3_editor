...
global_vars_status = [False] * len(global_vars)
global_vars_values = [""] * len(global_vars)
...
for fname in files:
    ...
    while step < 7:
        if step == 0:
            ...
            if not _track:
                continue
            # print file information to the user
            os.system('cls')
            print(sname)
            print(_track.pprint())
            ...
            if not global_vars_status[3]:
                ...
                if new_composer_sname == "" and new_composer_fname == "":
                    ...
                    actual_composer_sname = input(
                        "Entrer uniquement le nom du compositeur actuel[" + actual_var_value + "]:")
                    ...
                    step -= 1
                    while global_vars_status[step - 1]:
                        step -= 1
                    continue
                else:
            ...
            if not global_vars_status[step - 1]:
                ...
                while True:
                    new_var_value = input(
                        "Valeur pour l'attribut " + global_vars[step - 1] + " [" + actual_var_value + "]:")
